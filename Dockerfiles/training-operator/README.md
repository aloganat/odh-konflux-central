# training-operator -- Dockerfile.Konflux

## Components

| Side  | Component Name | Repo | Branch | Dockerfile |
|-------|---------------|------|--------|------------|
| ODH   | `odh-training-operator-ci` | `https://github.com/opendatahub-io/training-operator` | `stable` | `build/images/training-operator/Dockerfile.rhoai` |
| RHOAI | `odh-training-operator-v3-4` | `https://github.com/red-hat-data-services/training-operator.git` | `rhoai-3.4` | `build/images/training-operator/Dockerfile.konflux` |
