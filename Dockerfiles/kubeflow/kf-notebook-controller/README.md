...
|-------|---------------|------|--------|------------|
| ODH   | `odh-kf-notebook-controller-ci` | `https://github.com/opendatahub-io/kubeflow` | `stable` | `notebook-controller/Dockerfile` |
| RHOAI | `odh-kf-notebook-controller-v3-4` | `https://github.com/red-hat-data-services/kubeflow.git` | `rhoai-3.4` | `notebook-controller/Dockerfile.konflux` |
