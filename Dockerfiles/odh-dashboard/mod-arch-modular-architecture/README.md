...
|-------|---------------|------|--------|------------|
| ODH   | `odh-mod-arch-modular-architecture-ci` | `https://github.com/opendatahub-io/odh-dashboard` | `main` | `packages/model-registry/Dockerfile.workspace` |
| RHOAI | `odh-mod-arch-model-registry-v3-4` | `https://github.com/red-hat-data-services/odh-dashboard` | `rhoai-3.4` | `Dockerfile.konflux.modelregistry` |
