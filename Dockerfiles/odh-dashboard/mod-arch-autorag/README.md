...
|-------|---------------|------|--------|------------|
| ODH   | `odh-mod-arch-autorag-ci` | `https://github.com/opendatahub-io/odh-dashboard/` | `main` | `packages/autorag/Dockerfile.workspace` |
| RHOAI | `odh-mod-arch-autorag-v3-4` | `https://github.com/red-hat-data-services/odh-dashboard` | `rhoai-3.4` | `Dockerfile.konflux.autorag` |
