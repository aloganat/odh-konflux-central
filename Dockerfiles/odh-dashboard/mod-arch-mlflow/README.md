...
|-------|---------------|------|--------|------------|
| ODH   | `odh-mod-arch-mlflow` | `https://github.com/opendatahub-io/odh-dashboard.git` | `main` | `packages/mlflow/Dockerfile.workspace` |
| RHOAI | `odh-mod-arch-mlflow-v3-4` | `https://github.com/red-hat-data-services/odh-dashboard` | `rhoai-3.4` | `Dockerfile.konflux.mlflow` |
