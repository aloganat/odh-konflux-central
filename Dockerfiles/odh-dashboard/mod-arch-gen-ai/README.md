...
|-------|---------------|------|--------|------------|
| ODH   | `odh-mod-arch-gen-ai-ci` | `https://github.com/opendatahub-io/odh-dashboard` | `main` | `packages/gen-ai/Dockerfile.workspace` |
| RHOAI | `odh-mod-arch-gen-ai-v3-4` | `https://github.com/red-hat-data-services/odh-dashboard.git` | `rhoai-3.4` | `Dockerfile.konflux.genai` |
