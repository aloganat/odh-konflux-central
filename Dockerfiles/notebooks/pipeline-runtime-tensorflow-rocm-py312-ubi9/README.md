...
|-------|---------------|------|--------|------------|
| ODH   | `odh-pipeline-runtime-tensorflow-rocm-py312-ubi9-ci` | `https://github.com/opendatahub-io/notebooks` | `stable` | `runtimes/rocm-tensorflow/ubi9-python-3.12/Dockerfile.rocm` |
| RHOAI | `odh-wb-jupyter-pytorch-llmcompressor-cuda-py312-v3-4` | `https://github.com/red-hat-data-services/notebooks` | `rhoai-3.4` | `jupyter/pytorch+llmcompressor/ubi9-python-3.12/Dockerfile.konflux.cuda` |
