...
|-------|---------------|------|--------|------------|
| ODH   | `odh-workbench-jupyter-trustyai-cpu-py312-ubi9-ci` | `https://github.com/opendatahub-io/notebooks` | `stable` | `jupyter/trustyai/ubi9-python-3.12/Dockerfile.cpu` |
| RHOAI | `odh-workbench-jupyter-trustyai-cpu-py312-v3-4` | `https://github.com/red-hat-data-services/notebooks` | `rhoai-3.4` | `jupyter/trustyai/ubi9-python-3.12/Dockerfile.konflux.cpu` |
...
- ODH: base image uses tag, not digest: `cpu-base`
- ODH: base image uses tag, not digest: `jupyter-minimal`
- ODH: base image uses tag, not digest: `jupyter-datascience`
...
- RHOAI: base image uses tag, not digest: `cpu-base`
- RHOAI: base image uses tag, not digest: `jupyter-minimal`
- RHOAI: base image uses tag, not digest: `jupyter-datascience`
