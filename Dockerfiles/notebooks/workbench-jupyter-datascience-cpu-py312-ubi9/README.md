...
|-------|---------------|------|--------|------------|
| ODH   | `odh-workbench-jupyter-datascience-cpu-py312-ubi9-ci` | `https://github.com/opendatahub-io/notebooks` | `stable` | `jupyter/datascience/ubi9-python-3.12/Dockerfile.cpu` |
| RHOAI | `odh-workbench-jupyter-datascience-cpu-py312-v3-4` | `https://github.com/red-hat-data-services/notebooks` | `rhoai-3.4` | `jupyter/datascience/ubi9-python-3.12/Dockerfile.konflux.cpu` |
