...
|-------|---------------|------|--------|------------|
| ODH   | `odh-pipeline-runtime-minimal-cpu-py312-ubi9-ci` | `https://github.com/opendatahub-io/notebooks` | `stable` | `runtimes/minimal/ubi9-python-3.12/Dockerfile.cpu` |
| RHOAI | `odh-pipeline-runtime-minimal-cpu-py312-v3-4` | `https://github.com/red-hat-data-services/notebooks` | `rhoai-3.4` | `runtimes/minimal/ubi9-python-3.12/Dockerfile.konflux.cpu` |
