...
|-------|---------------|------|--------|------------|
| ODH   | `odh-workbench-jupyter-pytorch-cuda-py312-ubi9-ci` | `https://github.com/opendatahub-io/notebooks` | `stable` | `jupyter/pytorch/ubi9-python-3.12/Dockerfile.cuda` |
| RHOAI | `odh-workbench-jupyter-pytorch-cuda-py312-v3-4` | `https://github.com/red-hat-data-services/notebooks` | `rhoai-3.4` | `jupyter/pytorch/ubi9-python-3.12/Dockerfile.konflux.cuda` |
