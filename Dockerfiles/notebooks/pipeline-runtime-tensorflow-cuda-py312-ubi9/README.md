...
|-------|---------------|------|--------|------------|
| ODH   | `odh-pipeline-runtime-tensorflow-cuda-py312-ubi9-ci` | `https://github.com/opendatahub-io/notebooks` | `stable` | `runtimes/tensorflow/ubi9-python-3.12/Dockerfile.cuda` |
| RHOAI | `odh-pipeline-runtime-tensorflow-cuda-py312-v3-4` | `https://github.com/red-hat-data-services/notebooks` | `rhoai-3.4` | `runtimes/tensorflow/ubi9-python-3.12/Dockerfile.konflux.cuda` |
