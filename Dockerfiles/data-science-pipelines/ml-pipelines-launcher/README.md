...
|-------|---------------|------|--------|------------|
| ODH   | `odh-ml-pipelines-launcher-ci` | `https://github.com/opendatahub-io/data-science-pipelines` | `master` | `backend/Dockerfile.launcher` |
| RHOAI | `odh-ml-pipelines-launcher-v3-4` | `https://github.com/red-hat-data-services/data-science-pipelines.git` | `rhoai-3.4` | `backend/Dockerfile.konflux.launcher` |
