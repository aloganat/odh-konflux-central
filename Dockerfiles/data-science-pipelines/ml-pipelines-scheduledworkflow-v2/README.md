...
|-------|---------------|------|--------|------------|
| ODH   | `odh-ml-pipelines-scheduledworkflow-v2-ci` | `https://github.com/opendatahub-io/data-science-pipelines` | `master` | `backend/Dockerfile.scheduledworkflow` |
| RHOAI | `odh-ml-pipelines-scheduledworkflow-v2-v3-4` | `https://github.com/red-hat-data-services/data-science-pipelines.git` | `rhoai-3.4` | `backend/Dockerfile.konflux.scheduledworkflow` |
