...
|-------|---------------|------|--------|------------|
| ODH   | `odh-ml-pipelines-driver-ci` | `https://github.com/opendatahub-io/data-science-pipelines` | `master` | `backend/Dockerfile.driver` |
| RHOAI | `odh-ml-pipelines-driver-v3-4` | `https://github.com/red-hat-data-services/data-science-pipelines.git` | `rhoai-3.4` | `backend/Dockerfile.konflux.driver` |
