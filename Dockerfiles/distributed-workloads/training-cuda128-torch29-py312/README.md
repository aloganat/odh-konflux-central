...
|-------|---------------|------|--------|------------|
| ODH   | `odh-training-cuda128-torch29-py312-ci` | `https://github.com/opendatahub-io/distributed-workloads` | `stable` | `Dockerfile` |
| RHOAI | `odh-training-cuda128-torch29-py312-v3-4` | `https://github.com/red-hat-data-services/distributed-workloads` | `rhoai-3.4` | `Dockerfile.konflux` |
