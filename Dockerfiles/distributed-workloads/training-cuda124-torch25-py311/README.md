...
|-------|---------------|------|--------|------------|
| ODH   | `odh-training-cuda124-torch25-py311-ci` | `https://github.com/opendatahub-io/distributed-workloads.git` | `stable` | `Dockerfile` |
| RHOAI | `odh-training-cuda124-torch25-py311-v3-4` | `https://github.com/red-hat-data-services/distributed-workloads` | `rhoai-3.4` | `Dockerfile.konflux` |
