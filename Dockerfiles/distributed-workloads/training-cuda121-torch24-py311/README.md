...
|-------|---------------|------|--------|------------|
| ODH   | `odh-training-cuda121-torch24-py311-ci` | `https://github.com/opendatahub-io/distributed-workloads.git` | `stable` | `Dockerfile` |
| RHOAI | `odh-training-cuda121-torch24-py311-v3-4` | `https://github.com/red-hat-data-services/distributed-workloads` | `rhoai-3.4` | `Dockerfile.konflux` |
