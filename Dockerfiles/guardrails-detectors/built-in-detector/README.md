...
|-------|---------------|------|--------|------------|
| ODH   | `odh-built-in-detector-ci` | `https://github.com/opendatahub-io/guardrails-detectors.git` | `stable` | `Dockerfile.builtIn` |
| RHOAI | `odh-built-in-detector-v3-4` | `https://github.com/red-hat-data-services/guardrails-detectors` | `rhoai-3.4` | `Dockerfile.konflux.builtIn` |
