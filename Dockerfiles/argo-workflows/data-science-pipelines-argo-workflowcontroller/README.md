...
|-------|---------------|------|--------|------------|
| ODH   | `odh-data-science-pipelines-argo-workflowcontroller-ci` | `https://github.com/opendatahub-io/argo-workflows` | `main` | `argo-workflowcontroller/Dockerfile.ODH` |
| RHOAI | `odh-data-science-pipelines-argo-workflowcontroller-v3-4` | `https://github.com/red-hat-data-services/argo-workflows.git` | `rhoai-3.4` | `argo-workflowcontroller/Dockerfile.konflux` |
