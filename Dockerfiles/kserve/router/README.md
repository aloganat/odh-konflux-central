...
|-------|---------------|------|--------|------------|
| ODH   | `kserve-router-ci` | `https://github.com/opendatahub-io/kserve` | `master` | `router.Dockerfile` |
| RHOAI | `odh-kserve-controller-v3-4` | `https://github.com/red-hat-data-services/kserve` | `rhoai-3.4` | `Dockerfiles/controller.Dockerfile.konflux` |
