...
|-------|---------------|------|--------|------------|
| ODH   | `kserve-controller-ci` | `https://github.com/opendatahub-io/kserve` | `master` | `Dockerfile` |
| RHOAI | `odh-kserve-router-v3-4` | `https://github.com/red-hat-data-services/kserve` | `rhoai-3.4` | `Dockerfiles/router.Dockerfile.konflux` |
